...
//     // Test Google Login Only (No backend for now)
//     const handleGoogleAuth = async () => {
//         try {
//             const result = await signInWithPopup(auth, provider);
...
//                         className="w-full max-w-md bg-[#0b0b0b] rounded-2xl p-8 text-center border border-white/10"
//                         onClick={(e) => e.stopPropagation()}
//                     >
//                         <button
...
//                             whileTap={{ scale: 0.95 }}
//                             onClick={handleGoogleAuth}
//                             className="w-full h-12 rounded-lg bg-white text-black font-semibold flex items-center justify-center gap-3"
//                         >
//                             <img
            ...
            {open &&
                ...
                >
                    <motion.div
                        ...
                        animate={{ scale: 1, opacity: 1 }}
                        exit={{ scale: 0.9, opacity: 0 }}
                        className="relative w-full max-w-md bg-[#0b0b0b] rounded-2xl p-8 text-center border border-white/10"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <button
                            className='absolute top-4 right-4 text-zinc-400 hover:text-white'
